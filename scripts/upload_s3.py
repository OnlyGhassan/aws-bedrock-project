...
if __name__ == "__main__":
    # Folder path
    folder_path = "/mnt/c/Users/onlyg/Downloads/aws-bedrock-project/scripts/spec-sheets"
    
    # S3 bucket name
    bucket_name = "bedrock-kb-495690773549"  # Replace with your actual bucket name
